...
public class Ex07_MoveDelete {
	...
	public static void main(String[] args) {
		// ** File 준비
		File myFile = new File("D:\\MTest\\MyWork\\Java02\\src\\j16_fileClass\\Ex01_Method2.java");
		if (!myFile.exists()) {
			System.out.println("~~ 원본 화일이 준비되어있지 않습니다 ~~");
			return;
		}
//		// ** Dir 준비
		File newDir = new File("D:\\MTest\\MyWork\\Java02\\src\\testDir");
		if (!newDir.exists()) newDir.mkdir(); // dir이 없으면 생성
//		
//		// ** Move
//		// => renameTo : 변경 사항에 디렉토리가 포함되므로 위치가 변경됨
