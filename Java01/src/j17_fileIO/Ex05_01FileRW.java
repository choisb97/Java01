...
//    Byte Stream과는 다르게 운영체제에 맞게 인코딩 되어 있음을 알 수 있다.  

// => 실습 : OS 상에서 확인할 수 있는 형태로 알파벳 저장 & 출력하기
public class Ex05_01FileRW {

	public static void main(String[] args) throws IOException {
		// ** 문자 스트림 생성
		// => 없는 파일로 Test -> 생성 순서 중요
