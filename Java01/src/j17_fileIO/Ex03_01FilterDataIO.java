...
public class Ex03_01FilterDataIO {
	...
	public static void main(String[] args) throws IOException {
		// ** 스트림 생성
		// => 순서에 주의 (없는 문서를 만들 예정이므로) 
		
		// 1) 기본자료형 단위의 출력을 위한 필터스트림 DataOutputStream을 생성
		// => 출력스트림을 생성하고, 필터스트림 DataOutputStream과 연결한다.
...
//		DataOutputStream out = new DataOutputStream(fout);
		...
		// 2) 기본자료형 단위의 입력을 위한 필터스트림 DataInputStream을 생성
		// => 입력스트림을 생성하고, 필터스트림 DataInputStream과 연결한다.
		// => 단, read 스트림이므로 "dataType.txt" 파일은 반드시 존재해야 생성됨. 
