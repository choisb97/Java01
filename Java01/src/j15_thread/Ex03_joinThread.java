...
//=> Sum interface, Adder는 Thread 상속
...
// ** Adder
// => 1~100까지의 합을 멀티스레드 (2개)로 처리하는 클래스 
// => 조건 : interface Sum 구현 활용
//          연산구간은 생성자로 전달받아 초기화 한다.
//          연산 결과를 담을 변수는 num으로 정의한다. 
...
public class Ex03_joinThread {
	...
	public static void main(String[] args) {
		...
		try {
			ad1.join();
			ad2.join();
			// join() : 해당 쓰레드가 종료될 때까지 상위 쓰레드 실행 멈춤.
			// => ad1, ad2가 종료되어야 다음 문장 실행됨
		} catch (Exception e) {
