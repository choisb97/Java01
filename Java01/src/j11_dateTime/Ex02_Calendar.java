...
/*
 < Calendar >
 - 추상 클래스이므로 new 인스턴스 생성 불가
 - 날짜, 시간 계산법이 지역과 문화에 따라 다르기 때문에 꼭 필요한 메서드만 정의,
   특정한 역법을 따르는 경우엔 하위 클래스에서 구현하도록	

 < Formatter 활용 >
 - Calendar Type의 출력 Format 지원 
*/
...
public class Ex02_Calendar {
	...
	public static void main(String[] args) {
		...
		System.out.println("yy => "+yy); // 올 해 연도
	...
	//---------------------------------------------------------------------------------
		/*
		 < 다양한 Formatting 문자 >
		 - http://docs.oracle.com/javase/8/docs/api/Formatter 찾아보기
